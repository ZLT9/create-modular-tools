...
public class DataGenerator implements DataGeneratorEntrypoint {
    ...
    static class AdvancementsProvider extends FabricAdvancementProvider {
        ...
        public void generateAdvancement(Consumer<Advancement> consumer) {
            ...
            pickaxeHeadNbt.putString(AllTags.TOOL_MODULE_ID, AllToolModules.BRASS_PICKAXE_HEAD.getId());
            ...
            toolHandleNbt.putString(AllTags.TOOL_MODULE_ID, AllToolModules.NETHERITE_TOOL_HANDLE.getId());
            rootStackToolModulesNbt.put(AllToolModuleTypes.TOOL_HANDLE.getTag(), toolHandleNbt);
            CompoundTag toolGripNbt = new CompoundTag();
            toolGripNbt.putString(AllTags.TOOL_MODULE_ID, AllToolModules.ZINC_TOOL_GRIP.getId());
            rootStackToolModulesNbt.put(AllToolModuleTypes.TOOL_GRIP.getTag(), toolGripNbt);
            CompoundTag toolWrapNbt = new CompoundTag();
            toolWrapNbt.putString(AllTags.TOOL_MODULE_ID, AllToolModules.PURPLE_WOOL_TOOL_WRAP.getId());
