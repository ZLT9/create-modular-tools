...
public class ModularShovelItem extends ModularToolItem {
    public static final ResourceLocation ICON_ID = CreateModularTools.asResource("textures/gui/container/shovel.png");
    ...
    public Component getToolCategorySingularName() {
        return Component.translatable("tool_category.create_modular_tools.shovel.singular");
    }

    @Override
    public Component getToolCategoryPluralName() {
        return Component.translatable("tool_category.create_modular_tools.shovel.plural");
    }
