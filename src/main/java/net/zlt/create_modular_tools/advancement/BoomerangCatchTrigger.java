...
public class BoomerangCatchTrigger extends SimpleCriterionTrigger<BoomerangCatchTrigger.TriggerInstance> {
    public static final ResourceLocation ID = CreateModularTools.asResource("boomerang_caught");
