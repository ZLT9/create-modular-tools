...
public class BoomerangHitEntityTrigger extends SimpleCriterionTrigger<BoomerangHitEntityTrigger.TriggerInstance> {
    public static final ResourceLocation ID = CreateModularTools.asResource("boomerang_hit_entity");
