...
public class BoomerangThrowTrigger extends SimpleCriterionTrigger<BoomerangThrowTrigger.TriggerInstance> {
    public static final ResourceLocation ID = CreateModularTools.asResource("boomerang_thrown");
