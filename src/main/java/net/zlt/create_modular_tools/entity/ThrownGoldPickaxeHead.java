...
public class ThrownGoldPickaxeHead extends ThrownBoomerang {
    public ThrownGoldPickaxeHead(EntityType<? extends ThrownBoomerang> entityType, Level level) {
    ...
    protected float getAttackDamage() {
        return AllToolModules.GOLDEN_PICKAXE_HEAD.getAttackDamage();
    }
}
