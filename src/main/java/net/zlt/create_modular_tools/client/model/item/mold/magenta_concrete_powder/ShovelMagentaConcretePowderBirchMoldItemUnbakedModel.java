...
public class ShovelMagentaConcretePowderBirchMoldItemUnbakedModel extends ToolMagentaConcretePowderBirchMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new ShovelMagentaConcretePowderBirchMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
