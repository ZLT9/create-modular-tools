...
public class AxeLimeConcretePowderBirchMoldItemUnbakedModel extends ToolLimeConcretePowderBirchMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new AxeLimeConcretePowderBirchMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
