...
public class HoePinkConcretePowderCherryMoldItemUnbakedModel extends ToolPinkConcretePowderCherryMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new HoePinkConcretePowderCherryMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
