...
public class PickaxeYellowConcretePowderJungleMoldItemUnbakedModel extends ToolYellowConcretePowderJungleMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new PickaxeYellowConcretePowderJungleMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
