...
public class AxeCyanConcretePowderJungleMoldItemUnbakedModel extends ToolCyanConcretePowderJungleMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new AxeCyanConcretePowderJungleMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
