...
public class AxeCyanConcretePowderBambooMoldItemUnbakedModel extends ToolCyanConcretePowderBambooMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new AxeCyanConcretePowderBambooMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
