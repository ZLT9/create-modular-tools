...
public class HoeLightGrayConcretePowderBambooMoldItemUnbakedModel extends ToolLightGrayConcretePowderBambooMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new HoeLightGrayConcretePowderBambooMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
