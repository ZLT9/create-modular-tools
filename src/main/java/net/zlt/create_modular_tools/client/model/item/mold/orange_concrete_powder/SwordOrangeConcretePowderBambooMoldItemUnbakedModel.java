...
public class SwordOrangeConcretePowderBambooMoldItemUnbakedModel extends ToolOrangeConcretePowderBambooMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new SwordOrangeConcretePowderBambooMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
