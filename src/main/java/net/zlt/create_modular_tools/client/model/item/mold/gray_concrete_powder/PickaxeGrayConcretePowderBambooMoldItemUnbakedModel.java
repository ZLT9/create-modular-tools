...
public class PickaxeGrayConcretePowderBambooMoldItemUnbakedModel extends ToolGrayConcretePowderBambooMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new PickaxeGrayConcretePowderBambooMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
