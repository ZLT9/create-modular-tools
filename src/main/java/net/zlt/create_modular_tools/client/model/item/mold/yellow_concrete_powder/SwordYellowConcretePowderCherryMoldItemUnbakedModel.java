...
public class SwordYellowConcretePowderCherryMoldItemUnbakedModel extends ToolYellowConcretePowderCherryMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new SwordYellowConcretePowderCherryMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
