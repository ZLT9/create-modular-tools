...
public class HoeBrownConcretePowderJungleMoldItemUnbakedModel extends ToolBrownConcretePowderJungleMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new HoeBrownConcretePowderJungleMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
