...
public class ShovelYellowConcretePowderCherryMoldItemUnbakedModel extends ToolYellowConcretePowderCherryMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new ShovelYellowConcretePowderCherryMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
