...
public class HoeYellowConcretePowderMangroveMoldItemUnbakedModel extends ToolYellowConcretePowderMangroveMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new HoeYellowConcretePowderMangroveMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
