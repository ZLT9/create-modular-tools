...
public class AxeBlackConcretePowderSpruceMoldItemUnbakedModel extends ToolBlackConcretePowderSpruceMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new AxeBlackConcretePowderSpruceMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
