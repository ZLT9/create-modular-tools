...
public class PickaxeLimeConcretePowderAcaciaMoldItemUnbakedModel extends ToolLimeConcretePowderAcaciaMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new PickaxeLimeConcretePowderAcaciaMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
