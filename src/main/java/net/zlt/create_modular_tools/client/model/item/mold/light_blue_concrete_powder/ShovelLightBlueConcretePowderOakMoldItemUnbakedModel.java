...
public class ShovelLightBlueConcretePowderOakMoldItemUnbakedModel extends ToolLightBlueConcretePowderOakMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new ShovelLightBlueConcretePowderOakMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
