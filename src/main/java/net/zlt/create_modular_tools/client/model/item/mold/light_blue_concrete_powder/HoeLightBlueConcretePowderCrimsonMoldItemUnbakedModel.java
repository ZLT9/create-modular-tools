...
public class HoeLightBlueConcretePowderCrimsonMoldItemUnbakedModel extends ToolLightBlueConcretePowderCrimsonMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new HoeLightBlueConcretePowderCrimsonMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
