...
public class SwordWhiteConcretePowderWarpedMoldItemUnbakedModel extends ToolWhiteConcretePowderWarpedMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new SwordWhiteConcretePowderWarpedMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
