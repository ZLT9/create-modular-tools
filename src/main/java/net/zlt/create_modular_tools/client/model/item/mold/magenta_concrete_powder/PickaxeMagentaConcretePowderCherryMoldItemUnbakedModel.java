...
public class PickaxeMagentaConcretePowderCherryMoldItemUnbakedModel extends ToolMagentaConcretePowderCherryMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new PickaxeMagentaConcretePowderCherryMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
