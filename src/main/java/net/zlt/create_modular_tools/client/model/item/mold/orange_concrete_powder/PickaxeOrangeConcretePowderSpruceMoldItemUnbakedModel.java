...
public class PickaxeOrangeConcretePowderSpruceMoldItemUnbakedModel extends ToolOrangeConcretePowderSpruceMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new PickaxeOrangeConcretePowderSpruceMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
