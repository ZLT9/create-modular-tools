...
public class ShovelGrayConcretePowderMangroveMoldItemUnbakedModel extends ToolGrayConcretePowderMangroveMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new ShovelGrayConcretePowderMangroveMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
