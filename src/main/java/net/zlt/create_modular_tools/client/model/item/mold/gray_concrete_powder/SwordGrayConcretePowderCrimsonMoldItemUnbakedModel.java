...
public class SwordGrayConcretePowderCrimsonMoldItemUnbakedModel extends ToolGrayConcretePowderCrimsonMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new SwordGrayConcretePowderCrimsonMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
