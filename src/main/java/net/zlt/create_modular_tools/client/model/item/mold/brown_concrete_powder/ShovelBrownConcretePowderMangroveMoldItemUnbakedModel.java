...
public class ShovelBrownConcretePowderMangroveMoldItemUnbakedModel extends ToolBrownConcretePowderMangroveMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new ShovelBrownConcretePowderMangroveMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
