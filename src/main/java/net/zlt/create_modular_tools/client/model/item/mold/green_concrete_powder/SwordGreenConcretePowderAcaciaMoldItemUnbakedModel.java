...
public class SwordGreenConcretePowderAcaciaMoldItemUnbakedModel extends ToolGreenConcretePowderAcaciaMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new SwordGreenConcretePowderAcaciaMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
