...
public class ShovelWhiteConcretePowderBambooMoldItemUnbakedModel extends ToolWhiteConcretePowderBambooMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new ShovelWhiteConcretePowderBambooMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
