...
public class PickaxeBlueConcretePowderCrimsonMoldItemUnbakedModel extends ToolBlueConcretePowderCrimsonMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new PickaxeBlueConcretePowderCrimsonMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
