...
public class AxePurpleConcretePowderSpruceMoldItemUnbakedModel extends ToolPurpleConcretePowderSpruceMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new AxePurpleConcretePowderSpruceMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
