...
public class PickaxeWhiteConcretePowderMangroveMoldItemUnbakedModel extends ToolWhiteConcretePowderMangroveMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new PickaxeWhiteConcretePowderMangroveMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
