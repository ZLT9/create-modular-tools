...
public class AxeLightGrayConcretePowderJungleMoldItemUnbakedModel extends ToolLightGrayConcretePowderJungleMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new AxeLightGrayConcretePowderJungleMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
