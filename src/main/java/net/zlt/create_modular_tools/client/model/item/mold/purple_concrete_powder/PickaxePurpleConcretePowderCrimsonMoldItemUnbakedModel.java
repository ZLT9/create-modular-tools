...
public class PickaxePurpleConcretePowderCrimsonMoldItemUnbakedModel extends ToolPurpleConcretePowderCrimsonMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new PickaxePurpleConcretePowderCrimsonMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
