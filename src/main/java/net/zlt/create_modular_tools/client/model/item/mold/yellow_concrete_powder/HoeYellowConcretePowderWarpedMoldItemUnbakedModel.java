...
public class HoeYellowConcretePowderWarpedMoldItemUnbakedModel extends ToolYellowConcretePowderWarpedMoldItemUnbakedModel {
    @Override
    protected BakedModel createDynamic(BakedModel baseSandMoldModel, BakedQuad interiorTopQuad, Function<Material, TextureAtlasSprite> spriteGetter) {
        return new HoeYellowConcretePowderWarpedMoldItemDynamicBakedModel(baseSandMoldModel, interiorTopQuad, spriteGetter);
    }
