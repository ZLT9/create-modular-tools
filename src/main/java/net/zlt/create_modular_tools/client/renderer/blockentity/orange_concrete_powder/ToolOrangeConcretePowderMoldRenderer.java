...
public abstract class ToolOrangeConcretePowderMoldRenderer<T extends MoldBlockEntity> extends ToolMaterialMoldRenderer<T> {
    protected final Material BASE_MATERIAL = new Material(InventoryMenu.BLOCK_ATLAS, new ResourceLocation("minecraft", "block/orange_concrete_powder"));
