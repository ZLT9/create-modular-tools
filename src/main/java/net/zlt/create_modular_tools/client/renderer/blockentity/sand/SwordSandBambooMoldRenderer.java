...
public class SwordSandBambooMoldRenderer extends ToolSandMoldRenderer<SwordSandBambooMoldBlockEntity> {
    public SwordSandBambooMoldRenderer(BlockEntityRendererProvider.Context context) {
    }
