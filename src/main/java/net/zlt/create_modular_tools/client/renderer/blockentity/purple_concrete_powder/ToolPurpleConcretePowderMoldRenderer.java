...
public abstract class ToolPurpleConcretePowderMoldRenderer<T extends ToolMaterialMoldBlockEntity> extends ToolMaterialMoldRenderer<T> {
    protected final Material BASE_MATERIAL = new Material(InventoryMenu.BLOCK_ATLAS, new ResourceLocation("minecraft", "block/purple_concrete_powder"));
