...
public class CreateModularToolsClient implements ClientModInitializer {
    ...
    private static void registerForToolWrap(ToolModuleItem toolWrap, ResourceLocation idSword, ResourceLocation idPommelSword, ResourceLocation idShovel, ResourceLocation idGripShovel, ResourceLocation idPickaxe, ResourceLocation idGripPickaxe, ResourceLocation idAxe, ResourceLocation idGripAxe, ResourceLocation idHoe, ResourceLocation idGripHoe) {
        ...
        registerToolModuleModelIdGetterForToolWithoutModule(toolWrap, AllModularTools.SHOVEL, AllToolModuleTypes.TOOL_GRIP, idShovel);
        registerToolModuleModelIdGetterForToolWithoutModule(toolWrap, AllModularTools.PICKAXE, AllToolModuleTypes.TOOL_GRIP, idPickaxe);
        registerToolModuleModelIdGetterForToolWithoutModule(toolWrap, AllModularTools.AXE, AllToolModuleTypes.TOOL_GRIP, idAxe);
        registerToolModuleModelIdGetterForToolWithoutModule(toolWrap, AllModularTools.HOE, AllToolModuleTypes.TOOL_GRIP, idHoe);
        ...
        registerToolModuleModelIdGetterForToolWithModule(toolWrap, AllModularTools.SHOVEL, AllToolModuleTypes.TOOL_GRIP, idGripShovel);
        registerToolModuleModelIdGetterForToolWithModule(toolWrap, AllModularTools.PICKAXE, AllToolModuleTypes.TOOL_GRIP, idGripPickaxe);
        registerToolModuleModelIdGetterForToolWithModule(toolWrap, AllModularTools.AXE, AllToolModuleTypes.TOOL_GRIP, idGripAxe);
        registerToolModuleModelIdGetterForToolWithModule(toolWrap, AllModularTools.HOE, AllToolModuleTypes.TOOL_GRIP, idGripHoe);
    }
