...
public class CreateModularTools implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        Set<MaterialMoldBlock> shovelMolds = Set.of(AllMoldBlocks.SHOVEL_SAND_MOLD, AllMoldBlocks.SHOVEL_RED_SAND_MOLD, AllMoldBlocks.SHOVEL_WHITE_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_LIGHT_GRAY_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_GRAY_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_BLACK_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_BROWN_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_RED_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_ORANGE_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_YELLOW_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_LIME_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_GREEN_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_CYAN_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_LIGHT_BLUE_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_BLUE_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_PURPLE_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_MAGENTA_CONCRETE_POWDER_MOLD, AllMoldBlocks.SHOVEL_PINK_CONCRETE_POWDER_MOLD);
    ...
    private static void registerMoldTopTextureGetterForMold(ToolModuleType toolModuleType, MaterialMoldBlock materialMoldBlock, ToolModuleType.MoldTopTexture moldTopTexture) {
        toolModuleType.registerMoldTopTextureGetter((original, sandMoldBlock, nbt) -> original == null && sandMoldBlock == materialMoldBlock ? moldTopTexture : original);
    }

    private static void registerMoldTopTextureGetterForMoldsWithModule(ToolModuleType toolModuleType, Set<MaterialMoldBlock> materialMoldBlocks, ToolModuleType otherToolModuleType, ToolModuleType.MoldTopTexture moldTopTexture) {
        toolModuleType.registerMoldTopTextureGetter((original, sandMoldBlock, nbt) -> original == null && materialMoldBlocks.contains(sandMoldBlock) && nbt.contains(otherToolModuleType.getTag(), Tag.TAG_COMPOUND) ? moldTopTexture : original);
    }

    private static void registerMoldTopTextureGetterForMoldsWithoutModule(ToolModuleType toolModuleType, Set<MaterialMoldBlock> materialMoldBlocks, ToolModuleType otherToolModuleType, ToolModuleType.MoldTopTexture moldTopTexture) {
        toolModuleType.registerMoldTopTextureGetter((original, sandMoldBlock, nbt) -> original == null && materialMoldBlocks.contains(sandMoldBlock) && !nbt.contains(otherToolModuleType.getTag(), Tag.TAG_COMPOUND) ? moldTopTexture : original);
    }
}
