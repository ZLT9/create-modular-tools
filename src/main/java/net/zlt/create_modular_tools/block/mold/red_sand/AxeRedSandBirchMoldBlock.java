...
public class AxeRedSandBirchMoldBlock extends ToolRedSandBirchMoldBlock {
    public AxeRedSandBirchMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new AxeRedSandBirchMoldBlockEntity(pos, state);
    }
