...
public class RedSandWarpedMoldBlock extends MaterialMoldBlock {
    public RedSandWarpedMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    protected MaterialMoldBlock getHoeMoldBlock() {
        return AllMoldBlocks.HOE_RED_SAND_WARPED_MOLD;
    }
}
