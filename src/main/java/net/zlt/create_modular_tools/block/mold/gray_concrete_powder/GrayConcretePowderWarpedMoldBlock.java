...
public class GrayConcretePowderWarpedMoldBlock extends GrayConcretePowderMoldBlock {
    public GrayConcretePowderWarpedMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    protected ToolMaterialMoldBlock getSwordMoldBlock() {
        return AllMoldBlocks.SWORD_GRAY_CONCRETE_POWDER_WARPED_MOLD;
    }

    @Override
    protected ToolMaterialMoldBlock getShovelMoldBlock() {
        return AllMoldBlocks.SHOVEL_GRAY_CONCRETE_POWDER_WARPED_MOLD;
    }

    @Override
    protected ToolMaterialMoldBlock getPickaxeMoldBlock() {
        return AllMoldBlocks.PICKAXE_GRAY_CONCRETE_POWDER_WARPED_MOLD;
    }
    ...
    protected ToolMaterialMoldBlock getHoeMoldBlock() {
        return AllMoldBlocks.HOE_GRAY_CONCRETE_POWDER_WARPED_MOLD;
    }
}
