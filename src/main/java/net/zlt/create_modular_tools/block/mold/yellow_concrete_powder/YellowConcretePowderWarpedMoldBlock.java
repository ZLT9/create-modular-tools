...
public class YellowConcretePowderWarpedMoldBlock extends YellowConcretePowderMoldBlock {
    public YellowConcretePowderWarpedMoldBlock(Properties properties) {
        super(properties);
    }
