...
public class SwordSandOakMoldBlock extends ToolSandOakMoldBlock {
    public SwordSandOakMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new SwordSandOakMoldBlockEntity(pos, state);
    }
