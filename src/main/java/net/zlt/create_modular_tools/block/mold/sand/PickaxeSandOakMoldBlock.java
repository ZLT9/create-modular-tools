...
public class PickaxeSandOakMoldBlock extends ToolSandOakMoldBlock {
    public PickaxeSandOakMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new PickaxeSandOakMoldBlockEntity(pos, state);
    }
