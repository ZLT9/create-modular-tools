...
public class LightGrayConcretePowderAcaciaMoldBlock extends LightGrayConcretePowderMoldBlock {
    public LightGrayConcretePowderAcaciaMoldBlock(Properties properties) {
        super(properties);
    }
