...
public class LimeConcretePowderJungleMoldBlock extends LimeConcretePowderMoldBlock {
    public LimeConcretePowderJungleMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    protected ToolMaterialMoldBlock getShovelMoldBlock() {
        return AllMoldBlocks.SHOVEL_LIME_CONCRETE_POWDER_JUNGLE_MOLD;
    }

    @Override
    protected ToolMaterialMoldBlock getPickaxeMoldBlock() {
        return AllMoldBlocks.PICKAXE_LIME_CONCRETE_POWDER_JUNGLE_MOLD;
    }

    @Override
    protected ToolMaterialMoldBlock getAxeMoldBlock() {
        return AllMoldBlocks.AXE_LIME_CONCRETE_POWDER_JUNGLE_MOLD;
    }

    @Override
    protected ToolMaterialMoldBlock getHoeMoldBlock() {
        return AllMoldBlocks.HOE_LIME_CONCRETE_POWDER_JUNGLE_MOLD;
    }
}
