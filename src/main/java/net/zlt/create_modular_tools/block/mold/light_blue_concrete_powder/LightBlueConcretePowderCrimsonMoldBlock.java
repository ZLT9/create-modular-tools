...
public class LightBlueConcretePowderCrimsonMoldBlock extends LightBlueConcretePowderMoldBlock {
    public LightBlueConcretePowderCrimsonMoldBlock(Properties properties) {
        super(properties);
    }
