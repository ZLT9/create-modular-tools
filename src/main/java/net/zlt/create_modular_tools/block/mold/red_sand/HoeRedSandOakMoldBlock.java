...
public class HoeRedSandOakMoldBlock extends ToolRedSandOakMoldBlock {
    public HoeRedSandOakMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new HoeRedSandOakMoldBlockEntity(pos, state);
    }
