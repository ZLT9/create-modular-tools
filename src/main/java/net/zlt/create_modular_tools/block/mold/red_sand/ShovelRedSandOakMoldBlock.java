...
public class ShovelRedSandOakMoldBlock extends ToolRedSandOakMoldBlock {
    public ShovelRedSandOakMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new ShovelRedSandOakMoldBlockEntity(pos, state);
    }
