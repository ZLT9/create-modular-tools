...
public class LightBlueConcretePowderMangroveMoldBlock extends LightBlueConcretePowderMoldBlock {
    public LightBlueConcretePowderMangroveMoldBlock(Properties properties) {
        super(properties);
    }
