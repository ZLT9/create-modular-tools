...
public class PurpleConcretePowderCherryMoldBlock extends PurpleConcretePowderMoldBlock {
    public PurpleConcretePowderCherryMoldBlock(Properties properties) {
        super(properties);
    }
