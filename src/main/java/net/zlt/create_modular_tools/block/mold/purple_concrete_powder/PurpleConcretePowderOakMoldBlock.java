...
public class PurpleConcretePowderOakMoldBlock extends PurpleConcretePowderMoldBlock {
    public PurpleConcretePowderOakMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    protected ToolMaterialMoldBlock getSwordMoldBlock() {
        return AllMoldBlocks.SWORD_PURPLE_CONCRETE_POWDER_OAK_MOLD;
    }

    @Override
    protected ToolMaterialMoldBlock getShovelMoldBlock() {
        return AllMoldBlocks.SHOVEL_PURPLE_CONCRETE_POWDER_OAK_MOLD;
    }

    @Override
    protected ToolMaterialMoldBlock getPickaxeMoldBlock() {
        return AllMoldBlocks.PICKAXE_PURPLE_CONCRETE_POWDER_OAK_MOLD;
    }
    ...
    protected ToolMaterialMoldBlock getHoeMoldBlock() {
        return AllMoldBlocks.HOE_PURPLE_CONCRETE_POWDER_OAK_MOLD;
    }
}
