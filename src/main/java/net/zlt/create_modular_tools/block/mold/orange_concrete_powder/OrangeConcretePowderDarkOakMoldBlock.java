...
public class OrangeConcretePowderDarkOakMoldBlock extends OrangeConcretePowderMoldBlock {
    public OrangeConcretePowderDarkOakMoldBlock(Properties properties) {
        super(properties);
    }
