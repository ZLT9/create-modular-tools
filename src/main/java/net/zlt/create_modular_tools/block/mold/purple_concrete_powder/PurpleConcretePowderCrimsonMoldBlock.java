...
public class PurpleConcretePowderCrimsonMoldBlock extends PurpleConcretePowderMoldBlock {
    public PurpleConcretePowderCrimsonMoldBlock(Properties properties) {
        super(properties);
    }
