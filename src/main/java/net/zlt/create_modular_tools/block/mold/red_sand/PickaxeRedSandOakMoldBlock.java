...
public class PickaxeRedSandOakMoldBlock extends ToolRedSandOakMoldBlock {
    public PickaxeRedSandOakMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new PickaxeRedSandOakMoldBlockEntity(pos, state);
    }
