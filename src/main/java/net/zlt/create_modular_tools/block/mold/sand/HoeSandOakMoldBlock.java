...
public class HoeSandOakMoldBlock extends ToolSandOakMoldBlock {
    public HoeSandOakMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new HoeSandOakMoldBlockEntity(pos, state);
    }
