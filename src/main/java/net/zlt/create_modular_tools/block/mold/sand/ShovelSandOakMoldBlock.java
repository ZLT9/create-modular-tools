...
public class ShovelSandOakMoldBlock extends ToolSandOakMoldBlock {
    public ShovelSandOakMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new ShovelSandOakMoldBlockEntity(pos, state);
    }
