...
public class MagentaConcretePowderBambooMoldBlock extends MagentaConcretePowderMoldBlock {
    public MagentaConcretePowderBambooMoldBlock(Properties properties) {
        super(properties);
    }
