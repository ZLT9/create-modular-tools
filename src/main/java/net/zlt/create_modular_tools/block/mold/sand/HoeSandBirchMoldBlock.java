...
public class HoeSandBirchMoldBlock extends ToolSandBirchMoldBlock {
    public HoeSandBirchMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new HoeSandBirchMoldBlockEntity(pos, state);
    }
