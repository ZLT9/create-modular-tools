...
public class GrayConcretePowderCherryMoldBlock extends GrayConcretePowderMoldBlock {
    public GrayConcretePowderCherryMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    protected ToolMaterialMoldBlock getSwordMoldBlock() {
        return AllMoldBlocks.SWORD_GRAY_CONCRETE_POWDER_CHERRY_MOLD;
    }

    @Override
    protected ToolMaterialMoldBlock getShovelMoldBlock() {
        return AllMoldBlocks.SHOVEL_GRAY_CONCRETE_POWDER_CHERRY_MOLD;
    }
    ...
    protected ToolMaterialMoldBlock getAxeMoldBlock() {
        return AllMoldBlocks.AXE_GRAY_CONCRETE_POWDER_CHERRY_MOLD;
    }

    @Override
    protected ToolMaterialMoldBlock getHoeMoldBlock() {
        return AllMoldBlocks.HOE_GRAY_CONCRETE_POWDER_CHERRY_MOLD;
    }
}
