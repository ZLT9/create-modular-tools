...
public class AxeSandOakMoldBlock extends ToolSandOakMoldBlock {
    public AxeSandOakMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new AxeSandOakMoldBlockEntity(pos, state);
    }
