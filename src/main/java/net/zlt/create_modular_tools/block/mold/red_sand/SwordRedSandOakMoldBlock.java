...
public class SwordRedSandOakMoldBlock extends ToolRedSandOakMoldBlock {
    public SwordRedSandOakMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new SwordRedSandOakMoldBlockEntity(pos, state);
    }
