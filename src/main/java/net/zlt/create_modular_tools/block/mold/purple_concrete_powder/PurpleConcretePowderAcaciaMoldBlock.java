...
public class PurpleConcretePowderAcaciaMoldBlock extends PurpleConcretePowderMoldBlock {
    public PurpleConcretePowderAcaciaMoldBlock(Properties properties) {
        super(properties);
    }
