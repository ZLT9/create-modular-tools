...
public class HoeRedSandBirchMoldBlock extends ToolRedSandBirchMoldBlock {
    public HoeRedSandBirchMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new HoeRedSandBirchMoldBlockEntity(pos, state);
    }
