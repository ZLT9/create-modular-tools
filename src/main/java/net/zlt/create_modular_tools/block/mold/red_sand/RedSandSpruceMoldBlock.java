...
public class RedSandSpruceMoldBlock extends MaterialMoldBlock {
    public RedSandSpruceMoldBlock(Properties properties) {
        super(properties);
    }
    ...
    protected MaterialMoldBlock getAxeMoldBlock() {
        return AllMoldBlocks.AXE_RED_SAND_SPRUCE_MOLD;
    }

    @Override
    protected MaterialMoldBlock getHoeMoldBlock() {
        return AllMoldBlocks.HOE_RED_SAND_SPRUCE_MOLD;
    }
}
