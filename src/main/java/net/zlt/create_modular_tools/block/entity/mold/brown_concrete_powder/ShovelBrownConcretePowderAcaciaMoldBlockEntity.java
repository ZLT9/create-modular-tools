...
public class ShovelBrownConcretePowderAcaciaMoldBlockEntity extends ShovelMaterialMoldBlockEntity {
    public ShovelBrownConcretePowderAcaciaMoldBlockEntity(BlockPos pos, BlockState blockState) {
        super(AllMoldBlockEntityTypes.SHOVEL_BROWN_CONCRETE_POWDER_ACACIA_MOLD, pos, blockState);
    }
}
